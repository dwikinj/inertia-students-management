...
const deleteStudent = (id) => {
    if (confirm("Are you sure you want to delete this student?")) {
        deleteForm.delete(route("students.destroy", id), {
            ...
            onError: (errors) => {
                console.log("Failed to delete student", errors);
            },
        });
    }
};
...
const pageNumberUpdated = (url) => {
    if (url) {
        pageNumber.value = new URL(url).searchParams.get("page");
    }
};
</script>
                    ...
                    <div class="mt-8 flex flex-col">
                        ...
                        >
                            ...
                            >
                                ...
                                <Pagination :pagination="students"  :pageNumberUpdated="pageNumberUpdated"/>
                            </div>
                        </div>
                    </div>
                </div>
